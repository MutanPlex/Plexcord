...
declare module "usercss-meta" {
    ...
    export interface UserstyleHeader {
         ...
         *
         * @plexcord Specific to Plexcord, not part of the original module.
         */
        id: string;
         ...
         *
         * @plexcord This is a Plexcord-specific extension, however we wish for this to become a standard for client mods
         *          to implement, hence the more generic namespaced name.
         */
        "pc-requiredPlugins"?: string;
    }
