...
const CHANGELOG_HISTORY_KEY = "PlexcordChangelog_History";
const LAST_SEEN_HASH_KEY = "PlexcordChangelog_LastSeenHash";
const KNOWN_PLUGINS_KEY = "PlexcordChangelog_KnownPlugins";
const KNOWN_SETTINGS_KEY = "PlexcordChangelog_KnownSettings";
const LAST_REPO_CHECK_KEY = "PlexcordChangelog_LastRepoCheck";
