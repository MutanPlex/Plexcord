...
export function LinkIcon({ height = 24, width = 24, className }: IconProps) {
    return (
        <Icon
            height={height}
            width={width}
            className={classes(className, "pc-link-icon")}
            viewBox="0 0 24 24"
        >
...
export function CopyIcon(props: IconProps) {
    return (
        <Icon
            {...props}
            className={classes(props.className, "pc-copy-icon")}
            viewBox="0 0 24 24"
        >
            <g fill="currentColor">
...
export function OpenExternalIcon(props: IconProps) {
    return (
        <Icon
            {...props}
            className={classes(props.className, "pc-open-external-icon")}
            viewBox="0 0 24 24"
        >
...
export function ImageIcon(props: IconProps) {
    return (
        <Icon
            {...props}
            className={classes(props.className, "pc-image-icon")}
            viewBox="0 0 24 24"
        >
...
export function InfoIcon(props: IconProps) {
    return (
        <Icon
            {...props}
            className={classes(props.className, "pc-info-icon")}
            viewBox="0 0 24 24"
        >
            <path
                fill="currentColor"
...
export function OwnerCrownIcon(props: IconProps) {
    return (
        <Icon
            ...
            {...props}
            className={classes(props.className, "pc-owner-crown-icon")}
            role="img"
            viewBox="0 0 16 16"
        >
            <path
...
export function ScreenshareIcon(props: IconProps) {
    return (
        <Icon
            {...props}
            className={classes(props.className, "pc-screenshare-icon")}
            viewBox="0 0 24 24"
        >
            <path
                fill="currentColor"
...
export function ImageVisible(props: IconProps) {
    return (
        <Icon
            {...props}
            className={classes(props.className, "pc-image-visible")}
            viewBox="0 0 24 24"
        >
...
export function ImageInvisible(props: IconProps) {
    return (
        <Icon
            {...props}
            className={classes(props.className, "pc-image-invisible")}
            viewBox="0 0 24 24"
        >
...
export function Microphone(props: IconProps) {
    return (
        <Icon
            {...props}
            className={classes(props.className, "pc-microphone")}
            viewBox="0 0 24 24"
        >
...
export function CogWheel(props: IconProps) {
    return (
        <Icon
            {...props}
            className={classes(props.className, "pc-cog-wheel")}
            viewBox="0 0 24 24"
        >
            <path
                fill="currentColor"
...
export function ReplyIcon(props: IconProps) {
    return (
        <Icon
            {...props}
            className={classes(props.className, "pc-reply-icon")}
            viewBox="0 0 24 24"
        >
            <path
                fill="currentColor"
...
export function DeleteIcon(props: IconProps) {
    return (
        <Icon
            {...props}
            className={classes(props.className, "pc-delete-icon")}
            viewBox="0 0 24 24"
        >
            <path
                fill="currentColor"
...
export function PluginIcon(props: IconProps) {
    return (
        <Icon
            {...props}
            className={classes(props.className, "pc-plugin-icon")}
            viewBox="0 0 24 24"
        >
            <path
                fill="currentColor"
...
export function PlusIcon(props: IconProps) {
    return (
        <Icon
            {...props}
            className={classes(props.className, "pc-plus-icon")}
            viewBox="0 0 18 18"
        >
            <polygon
                fillRule="nonzero"
...
export function NoEntrySignIcon(props: IconProps) {
    return (
        <Icon
            {...props}
            className={classes(props.className, "pc-no-entry-sign-icon")}
            viewBox="0 0 24 24"
        >
...
export function PasteIcon(props: IconProps) {
    return (
        <Icon
            {...props}
            className={classes(props.className, "pc-paste-icon")}
            viewBox="0 0 24 24"
            fill="none"
            stroke="currentColor"
            stroke-width="2"
...
export function SafetyIcon(props: IconProps) {
    return (
        <Icon
            {...props}
            className={classes(props.className, "pc-safety-icon")}
            viewBox="0 0 24 24"
        >
            <path
                fill="currentColor"
...
export function NotesIcon(props: IconProps) {
    return (
        <Icon
            {...props}
            className={classes(props.className, "pc-notes-icon")}
            viewBox="0 0 24 24"
        >
            <path
                fill="currentColor"
...
export function IDIcon(props: IconProps) {
    return (
        <Icon
            {...props}
            className={classes(props.className, "pc-id-icon")}
            viewBox="0 0 24 24"
        >
            <path
                fill="currentColor"
...
export function FolderIcon(props: IconProps) {
    return (
        <Icon
            {...props}
            className={classes(props.className, "pc-folder-icon")}
            viewBox="0 0 24 24"
        >
            <path
                fill="currentColor"
...
export function LogIcon(props: IconProps) {
    return (
        <Icon
            {...props}
            className={classes(props.className, "pc-log-icon")}
            viewBox="0 0 24 24"
        >
            <path
                fill="currentColor"
...
export function RestartIcon(props: IconProps) {
    return (
        <Icon
            {...props}
            className={classes(props.className, "pc-restart-icon")}
            viewBox="0 0 24 24"
        >
            <path
                fill="currentColor"
...
export function PaintbrushIcon(props: IconProps) {
    return (
        <Icon
            {...props}
            className={classes(props.className, "pc-paintbrush-icon")}
            viewBox="0 0 24 24"
        >
            <path
                fill="currentColor"
...
export function PencilIcon(props: IconProps) {
    return (
        <Icon
            {...props}
            className={classes(props.className, "pc-pencil-icon")}
            viewBox="0 0 24 24"
        >
            <path
                fill="currentColor"
...
export function ChangelogIcon(props: IconProps) {
    return (
        <Icon {...props} viewBox="0 0 24 24" fill="none" stroke={props.fill || "currentColor"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <path d="M8 2H16C17.1 2 18 2.9 18 4V22L12 19L6 22V4C6 2.9 6.9 2 8 2Z" />
...
export function PlextronSettingsIcon(props: IconProps) {
    return (
        <Icon {...props} viewBox="0 0 24 24">
            <path
                fill={props.fill || "currentColor"}
