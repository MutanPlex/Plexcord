...
function PlexcordPopoverButtons(props: { Component: React.ComponentType<MessagePopoverButtonItem>, message: Message; }) {
...
export function _buildPopoverElements(
    ...
    return <PlexcordPopoverButtons Component={Component} message={message} />;
}
