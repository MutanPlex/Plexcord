...
const settings = definePluginSettings({
    ...
    position: {
        ...
        onChange: value => {
            ...
            const charCounterDiv = document.querySelector(".pc-char-counter");
            if (charCounterDiv) {
...
const addCharCounter = () => {
    ...
    let charCounterDiv: HTMLElement | null = document.querySelector(".pc-char-counter");
    if (!charCounterDiv) {
        charCounterDiv = document.createElement("div");
        charCounterDiv.classList.add("pc-char-counter");
        ...
        charCounterDiv.innerHTML = `<span class="pc-char-count">0</span>/<span class="pc-char-max">${charMax}</span>`;
    ...
    const updateCharCount = () => {
        ...
        const charCountSpan: HTMLElement | null = charCounterDiv!.querySelector(".pc-char-count");
...
export default definePlugin({
    ...
    authors: [PcDevs.creations, PcDevs.Panniku, PcDevs.MutanPlex],
    settings: settings,
