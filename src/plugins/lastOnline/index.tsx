...
export default definePlugin({
    ...
    patches: [
        ...
        // Patches the DM list
        {
            ...
            replacement: {
                match: /(\{user:(\i),activities:\i,voiceChannel:\i,applicationStream:\i.{0,200}\})\):null(,\w+:\(0,)/,
                replace: "$1):$self.shouldShowRecentlyOffline($2)?$self.buildRecentlyOffline($2):null$3"
            }
        }
    ],
