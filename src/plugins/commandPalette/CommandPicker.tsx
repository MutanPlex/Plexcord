...
function CommandPickerModal({ modalProps, allowMultiple = false, initialQuery = "", initialSelectedIds = [], filter: filterPredicate, onSelect, onComplete, onClose }: CommandPickerProps & { modalProps: any; }) {
    ...
    const headerText = allowMultiple ? t(plugin.commandPalette.modal.add.title) : t(plugin.commandPalette.modal.choose.title);
            ...
            <div className={cl("container")} onKeyDown={handleKeyDown}>
                ...
                >
                    ...
                    <TextInput
                        ...
                        value={query}
                        onChange={setQuery}
                        placeholder={t(plugin.commandPalette.modal.searchPlaceholder)}
                    />
                </div>
                <div className={cl("list")}>
                    {!hasCommands && (
                        <div className={cl("empty")}>{t(plugin.commandPalette.modal.noCommand)}</div>
                    )}
