            ...
            >
                <div className={cl("header")}>
                    <div className={cl("header-top")}>
                        <span className={cl("title")}>{t(plugin.commandPalette.modal.command.palette.label)}</span>
                        {showBreadcrumb && (
                    ...
                    >
                        ...
                        <TextInput
                            ...
                            placeholder={t(plugin.commandPalette.modal.command.palette.placeholder)}
                        />
                    </div>
                </div>
                    ...
                    >
                        ...
                        {activeTagLabels.length > 0 && (
                            <div className={cl("tag-status")}>
                                {t(plugin.commandPalette.modal.command.palette.filtering, { tags: activeTagLabels.join(", ") })}
                            </div>
                        )}
                    </div>
                )}
                <div className={cl("list")} ref={listRef}>
                    {items.length === 0 && (
                        <div className={cl("empty")}>{t(plugin.commandPalette.modal.command.palette.noCommand)}</div>
                    )}
                            ...
                            >
                                <div className={cl("item-content")}>
                                    ...
                                    <span
                                        ...
                                        role="button"
                                        aria-label={pinned ? t(plugin.commandPalette.modal.command.palette.unpin) : t(plugin.commandPalette.modal.command.palette.pin)}
                                        title={pinned ? t(plugin.commandPalette.modal.command.palette.unpin) : t(plugin.commandPalette.modal.command.palette.pin)}
                                    >
                                        {pinned ? "★" : "☆"}
                                    </span>
                                </div>
