                                ...
                                {isRenaming ? (
                                    ...
                                    <>
                                        ...
                                        <div className={cl("timestamp")}>
                                            {t(plugin.profileSets.modal.timestamp, { formattedDate, formattedTime })}
                                        </div>
                                    </>
                                )}
                            </div>
                                ...
                                onClick={e => {
                                    ...
                                    ContextMenuApi.openContextMenu(e, () => (
                                        <Menu.Menu navId="preset-options" onClose={ContextMenuApi.closeContextMenu}>
                                            <Menu.MenuItem
                                                id="rename"
                                                label={t(plugin.profileSets.modal.rename)}
                                                action={() => {
                                            ...
                                            <Menu.MenuItem
                                                id="update"
                                                label={t(plugin.profileSets.modal.update)}
                                                action={async () => {
                                            ...
                                            {actualIndex > 0 && (
                                                <Menu.MenuItem
                                                    id="move-up"
                                                    label={t(plugin.profileSets.modal.moveUp)}
                                                    action={() => {
                                            ...
                                            {actualIndex < allPresets.length - 1 && (
                                                <Menu.MenuItem
                                                    id="move-down"
                                                    label={t(plugin.profileSets.modal.moveDown)}
                                                    action={() => {
                                                        movePreset(actualIndex, actualIndex + 1, section, guildId);
                                                        onUpdate();
                                                    }}
                                            ...
                                            {currentPage > 1 && (
                                                <Menu.MenuItem
                                                    id="move-to-page-1"
                                                    label={t(plugin.profileSets.modal.moveTo)}
                                                    action={() => {
                                            ...
                                            <Menu.MenuItem
                                                id="delete"
                                                label={t(plugin.profileSets.modal.delete)}
                                                color="danger"
                                                action={async () => {
