...
export default definePlugin({
    ...
    authors: [PcDevs.TheArmagan, Devs.Elvyra, PcDevs.MutanPlex],
    settings,
    patches: [
        {
    ...
    generateButtons(props: { user: User, originalProps: ButtonProps, isBlocked: boolean; }) {
        ...
        return <div style={{ display: "flex", gap: "8px" }} className="pc-bbc-button-container">
            {dmButton}
            {unblockButton}
        </div>;
    },
    ...
    openConfirmationModal(event: MouseEvent, callback: () => any, user: User | string, isSettingsOrigin: boolean = false) {
        ...
        return openModal(m => <ConfirmationModal
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "16px" }} className="pc-bbc-confirmation-modal-text">
