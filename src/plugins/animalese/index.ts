...
const settings = definePluginSettings({
    volume: {
        label: () => t(plugin.animalese.option.volume.label),
        description: () => t(plugin.animalese.option.volume.description),
        type: OptionType.SLIDER,
        default: 0.5,
        markers: [0, 0.1, 0.25, 0.5, 0.6, 0.75, 1],
    },
    speed: {
        label: () => t(plugin.animalese.option.speed.label),
        description: () => t(plugin.animalese.option.speed.description),
        type: OptionType.SLIDER,
        default: 1,
        markers: [0.5, 0.75, 1, 1.25, 1.5],
    },
    pitch: {
        label: () => t(plugin.animalese.option.pitch.label),
        description: () => t(plugin.animalese.option.pitch.description),
        type: OptionType.SLIDER,
        default: 1,
        markers: [0.75, 0.8, 0.85, 1, 1.15, 1.25, 1.35, 1.5],
    },
    messageLengthLimit: {
        label: () => t(plugin.animalese.option.messageLengthLimit.label),
        description: () => t(plugin.animalese.option.messageLengthLimit.description),
        type: OptionType.NUMBER,
        default: 50,
    },
    processOwnMessages: {
        label: () => t(plugin.animalese.option.processOwnMessages.label),
        description: () => t(plugin.animalese.option.processOwnMessages.description),
        type: OptionType.BOOLEAN,
        default: true,
    },
    soundQuality: {
        label: () => t(plugin.animalese.option.soundQuality.label),
        description: () => t(plugin.animalese.option.soundQuality.description),
        type: OptionType.SELECT,
        options: [
            {
                label: () => t(plugin.animalese.option.soundQuality.high),
                value: "high",
                default: true
            },
            {
                label: () => t(plugin.animalese.option.soundQuality.med),
                value: "med"
            },
            {
                label: () => t(plugin.animalese.option.soundQuality.low),
                value: "low"
            },
            {
                label: () => t(plugin.animalese.option.soundQuality.lowest),
                value: "low"
            }
        ]
    }
...
const BASE_URL_HIGH = "https://raw.githubusercontent.com/MutanPlex/random-files/main/sounds/animalese";
