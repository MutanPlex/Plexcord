...
const cl = classNameFactory("pc-exitsounds-");
        ...
        <div className={cl("input-row")}>
            <div className={cl("input-wrapper")}>
                <TextInput
                    ...
                    placeholder={t(plugin.exitSounds.option.soundId.placeholder)}
                />
            </div>
            <Button
...
const settings = definePluginSettings({
    soundGuildId: {
        label: () => t(plugin.exitSounds.option.soundGuildId.label),
        description: () => t(plugin.exitSounds.option.soundGuildId.description),
        type: OptionType.COMPONENT,
        component: GuildSelector
    },
    soundId: {
        label: () => t(plugin.exitSounds.option.soundId.label),
        description: () => t(plugin.exitSounds.option.soundId.description),
        type: OptionType.COMPONENT,
    ...
    children.splice(1, 0,
        <Menu.MenuGroup>
            <Menu.MenuItem
                ...
                label={t(plugin.exitSounds.button)}
                action={() => {
