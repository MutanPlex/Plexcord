...
function getQuestAcceptedButtonText(quest: Quest): string | null {
    ...
    if (questEnrolledAt) {
        if (((playType && completeGameQuestsInBackground && IS_DISCORD_DESKTOP) || (watchType && completeVideoQuestsInBackground))) {
            ...
            if (!!intervalData) {
                return !canCompleteImmediately && timeRemaining ? t(plugin.questify.button.questInProgressWithTime, { remainTime: progressFormatted }) : t(plugin.questify.button.completing);
