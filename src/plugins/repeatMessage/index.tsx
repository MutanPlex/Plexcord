...
function RepeatMessageIcon({ className }: { className?: string; }) {
    return (
        <svg
            ...
            height={24}
            width={24}
            className={classes(classNameFactory("pc-repeat-")("icon"), className)}
        >
...
function setTitle(title: string) {
    const contextMenuOption = document.querySelector("#message-pc-repeat .label__563c3");
...
export default definePlugin({
    ...
    authors: [PcDevs.Tolgchu, PcDevs.MutanPlex],
    contextMenus: {
        "message": messageCtxPatch
    },
    start() {
        addMessagePopoverButton("pc-repeat", message => {
    ...
    stop() {
        removeMessagePopoverButton("pc-repeat");
