...
export const cl = classNameFactory("pc-shc-");
...
export const settings = definePluginSettings({
    channelStyle: {
        label: () => t(plugin.showHiddenChannels.option.channelStyle.label),
        description: () => t(plugin.showHiddenChannels.option.channelStyle.description),
        type: OptionType.SELECT,
        options: [
            { label: () => t(plugin.showHiddenChannels.option.channelStyle.classic), value: ChannelStyle.Classic, default: true },
            { label: () => t(plugin.showHiddenChannels.option.channelStyle.muted), value: ChannelStyle.Muted },
            { label: () => t(plugin.showHiddenChannels.option.channelStyle.showUnreads), value: ChannelStyle.Unread },
            { label: () => t(plugin.showHiddenChannels.option.channelStyle.mutedWithUnreads), value: ChannelStyle.MutedUnread }
        ],
        restartNeeded: true
    },
    showMode: {
        ...
        options: [
            ...
            { label: () => t(plugin.showHiddenChannels.option.showMode.hidden), value: ShowMode.EyeIconRight },
            { label: () => t(plugin.showHiddenChannels.option.showMode.lockIconRight), value: ShowMode.LockIconRight }
        ],
        restartNeeded: true
    },
        ...
        },
        {
            ...
            replacement: [
                ...
                },
                {
                    ...
                    replace: (m, channel, permCheck) => `${m}!Plexcord.Webpack.Common.PermissionStore.can(${CONNECT}n,${channel})?${permCheck}CONNECT):`
                },
                {
