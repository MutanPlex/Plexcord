...
function handleColorChange(value, settingKey, defaultValue) {
    ...
    if (!value.match(rgbPattern)) {
        ...
        if (rgb.match(rgbPattern)) {
            ...
            showToast(t(plugin.betterAudioPlayer.toast.invalidColorFormat, { settingKey }), Toasts.Type.FAILURE);
...
const settings = definePluginSettings({
    oscilloscope: {
        label: () => t(plugin.betterAudioPlayer.option.oscilloscope.label),
        description: () => t(plugin.betterAudioPlayer.option.oscilloscope.description),
        type: OptionType.BOOLEAN,
        default: true,
    },
    spectrograph: {
        label: () => t(plugin.betterAudioPlayer.option.spectrograph.label),
        description: () => t(plugin.betterAudioPlayer.option.spectrograph.description),
        type: OptionType.BOOLEAN,
        default: true,
    },
    oscilloscopeSolidColor: {
        label: () => t(plugin.betterAudioPlayer.option.oscilloscopeSolidColor.label),
        description: () => t(plugin.betterAudioPlayer.option.oscilloscopeSolidColor.description),
        type: OptionType.BOOLEAN,
        default: false,
    },
    oscilloscopeColor: {
        label: () => t(plugin.betterAudioPlayer.option.oscilloscopeColor.label),
        description: () => t(plugin.betterAudioPlayer.option.oscilloscopeColor.description),
        type: OptionType.STRING,
        default: "255, 255, 255",
        onChange: value => handleColorChange(value, "oscilloscopeColor", "255, 255, 255"),
    },
    spectrographSolidColor: {
        label: () => t(plugin.betterAudioPlayer.option.spectrographSolidColor.label),
        description: () => t(plugin.betterAudioPlayer.option.spectrographSolidColor.description),
        type: OptionType.BOOLEAN,
        default: false,
    },
    spectrographColor: {
        label: () => t(plugin.betterAudioPlayer.option.spectrographColor.label),
        description: () => t(plugin.betterAudioPlayer.option.spectrographColor.description),
        type: OptionType.STRING,
        default: "33, 150, 243",
        onChange: value => handleColorChange(value, "spectrographColor", "33, 150, 243"),
    },
    forceMoveBelow: {
        label: () => t(plugin.betterAudioPlayer.option.forceMoveBelow.label),
        description: () => t(plugin.betterAudioPlayer.option.forceMoveBelow.description),
        type: OptionType.BOOLEAN,
        default: true,
    },
});
