...
const cl = classNameFactory("pc-element-highlight-");
...
function KeybindRecorder() {
    ...
    return (
        <div className={cl("keybind-row")}>
            ...
            >
                {isListening ? t(plugin.elementHighlighter.modal.recording) : <KeybindShortcut shortcut={currentKeybind.join("+")} />}
            </button>
            <Button
                size="small"
                variant="secondary"
            ...
            >
                {t(plugin.elementHighlighter.modal.reset)}
            </Button>
        </div>
    );
}
...
const settings = definePluginSettings({
    keybind: {
        label: () => t(plugin.elementHighlighter.option.keybind.label),
        description: () => t(plugin.elementHighlighter.option.keybind.description),
        type: OptionType.COMPONENT,
        default: DEFAULT_KEYBIND,
        component: KeybindRecorder
    },
    showClasses: {
        label: () => t(plugin.elementHighlighter.option.showClasses.label),
        description: () => t(plugin.elementHighlighter.option.showClasses.description),
        type: OptionType.BOOLEAN,
        default: false
    },
    showId: {
        label: () => t(plugin.elementHighlighter.option.showId.label),
        description: () => t(plugin.elementHighlighter.option.showId.description),
        type: OptionType.BOOLEAN,
        default: false
    },
    showFont: {
        label: () => t(plugin.elementHighlighter.option.showFont.label),
        description: () => t(plugin.elementHighlighter.option.showFont.description),
        type: OptionType.BOOLEAN,
        default: false
    },
    showPadding: {
        label: () => t(plugin.elementHighlighter.option.showPadding.label),
        description: () => t(plugin.elementHighlighter.option.showPadding.description),
        type: OptionType.BOOLEAN,
        default: false
    },
    showMargin: {
        label: () => t(plugin.elementHighlighter.option.showMargin.label),
        description: () => t(plugin.elementHighlighter.option.showMargin.description),
        type: OptionType.BOOLEAN,
        default: false
    },
    showBorderRadius: {
        label: () => t(plugin.elementHighlighter.option.showBorderRadius.label),
        description: () => t(plugin.elementHighlighter.option.showBorderRadius.description),
        type: OptionType.BOOLEAN,
        default: false
    },
    showPosition: {
        label: () => t(plugin.elementHighlighter.option.showPosition.label),
        description: () => t(plugin.elementHighlighter.option.showPosition.description),
        type: OptionType.BOOLEAN,
        default: false
    },
    showDisplay: {
        label: () => t(plugin.elementHighlighter.option.showDisplay.label),
        description: () => t(plugin.elementHighlighter.option.showDisplay.description),
        type: OptionType.BOOLEAN,
        default: false
    }
});
...
function onClick(e: MouseEvent) {
    ...
    if (colorVar) copyWithToast(colorVar, t(plugin.elementHighlighter.toast.copied.color));
}
