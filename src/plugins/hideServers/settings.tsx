...
export default definePluginSettings({
    showIndicator: {
        label: () => t(plugin.hideServers.option.showIndicator.label),
        description: () => t(plugin.hideServers.option.showIndicator.description),
    ...
    guildsList: {
        label: () => t(plugin.hideServers.option.guildsList.label),
        description: () => t(plugin.hideServers.option.guildsList.description),
    ...
    resetHidden: {
        label: () => t(plugin.hideServers.option.resetHidden.label),
        description: () => t(plugin.hideServers.option.resetHidden.description),
        type: OptionType.COMPONENT,
        component: () => (
            <div>
                <Button
