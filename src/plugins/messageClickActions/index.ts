    ...
    onMessageClick(msg: any, channel, event) {
        ...
        if (!isDeletePressed) {
            ...
            if (isMe) {
                ...
                const NoReplyMention = Plexcord.Plugins.plugins.NoReplyMention as any as typeof import("../noReplyMention").default;
                const shouldMention = Plexcord.Plugins.isPluginEnabled("NoReplyMention")
