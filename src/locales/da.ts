    ...
    plugin: {
        ...
        messageLoggerEnhanced: {
            ...
            option: {
                ...
                clearLogsOnRestart: {
                    label: "Ryd logs ved genstart",
                    description: "Rydder logs når Discord genstarter."
                },
                openLogs: {
                    label: "Åbn logs",
        ...
        streamingCodecDisabler: {
            ...
            option: {
                ...
                disableVP8Codec: {
                    label: "Deaktiver VP8 Codec",
                    description: "Forhindrer Discord i at bruge VP8 til streaming."
                },
                disableVP9Codec: {
                    label: "Deaktiver VP9 Codec",
                    description: "Forhindrer Discord i at bruge VP9 til streaming."
                }
            }
        },
        superReactionTweaks: {
