...
const translations: MatchStructure<typeof enTranslations> = {
    settings: {
        ...
        switches: {
            useQuickCss: {
                ...
                description: "Load custom CSS from the QuickCSS editor. This allows you to customise Discord's appearance with your own styles."
            },
            enableReactDevtools: {
        ...
        settingsSection: {
            title: "Settings",
            description: "Configure how Plexcord behaves and integrates with Discord. These settings affect the Discord client's appearance and behaviour.",
            hintParts: {
                prefix: "You can customise where this settings section appears in Discord's settings menu by configuring the {{pluginLink}}",
                linkText: "Settings Plugin"
            }
        },
        notifications: {
            title: "Notifications",
            description: "Configure how Plexcord handles notifications. You can customise when and how you receive alerts, or view a history of past notifications.",
        ...
        macVibrancy: {
            ...
            description: "Customise the macOS window vibrancy effect. This controls the blur and transparency style of the Discord window. Changes require a restart to take effect.",
    ...
    plugins: {
        ...
        error: {
            ...
            infoRender: "An error occurred while rendering this plugin's custom Info Component"
        },
        placeholder: {
        ...
        dangerModal: {
            ...
            undone: "This action cannot be undone. Are you sure?",
        ...
        metadata: {
            api: {
                description: {
                    ...
                    profileCollections: "API to add collections to the user profile panel like Discord's game collection."
                },
                chatButtons: {
                    context: {
                        buttons: "Buttons"
    ...
    sync: {
        ...
        settings: {
            ...
            datastores: "Plugin DataStores (e.g. Time zones or IRememberYou)"
        },
        import: {
        ...
        error: {
            ...
            api: {
                returned: {
                    ...
                    manifest: "Could not retrieve manifest for deletion (API returned {{status}})."
                }
            },
            synchronize: {
    ...
    plugin: {
        ...
        supportHelper: {
            ...
            modals: {
                outdated: {
                    ...
                    footer: "Please update first before asking for support!",
                    button: {
                        cancel: "View Updates",
        ...
        accountPanelServerProfile: {
            ...
            option: {
                prioritizeServerProfile: {
                    label: "Prioritise Server Profile",
                    description: "Prioritise Server Profile when left clicking your account panel"
                }
            },
            context: {
                account: "View Account Profile",
                server: "View Server Profile",
                prioritize: "Prioritise Server Profile"
            }
        },
        altKrispSwitch: {
            name: "AltKrispSwitch",
        ...
        appleMusic: {
            ...
            about: "For the customisable activity format strings, you can use several special strings to include track data in activities! {{name}} is replaced with the track name; {{artist}} is replaced with the artist(s)' name(s); and {{album}} is replaced with the album name.",
            button: {
        ...
        betterAudioPlayer: {
            ...
            description: "Adds a spectrograph and oscilloscope visualiser to audio attachment players",
            option: {
                oscilloscope: {
                    label: "Oscilloscope",
                    description: "Enable oscilloscope visualiser"
                },
                spectrograph: {
                    label: "Spectrograph",
                    description: "Enable spectrograph visualiser"
                },
                oscilloscopeSolidColor: {
                    label: "Oscilloscope Solid Colour",
                    description: "Use a solid colour for the oscilloscope instead of a gradient"
                },
                oscilloscopeColor: {
                    label: "Oscilloscope Colour",
                    description: "Colour of the oscilloscope when solid colour is enabled"
                },
                spectrographSolidColor: {
                    label: "Spectrograph Solid Colour",
                    description: "Use a solid colour for the spectrograph instead of a gradient"
                },
                spectrographColor: {
                    label: "Spectrograph Colour",
                    description: "Colour of the spectrograph when solid colour is enabled"
                }
            },
            toast: {
                invalidColorFormat: "Invalid colour format for {{settingKey}}, make sure it's in the format 'R, G, B' or '#RRGGBB'"
            }
        },
        betterBanReasons: {
        ...
        betterRoleContext: {
            ...
            description: "Adds options to copy role colour / edit role / view role icon when right clicking roles in the user profile",
            option: {
                roleIconFileFormat: {
        ...
        betterRoleDot: {
            ...
            option: {
                ...
                copyRoleColorInProfilePopout: {
                    label: "Copy Role Colour in Profile Popout",
                    description: "Allow click on role dot in profile popout to copy role colour"
                }
            }
        },
        betterSessions: {
        ...
        betterSettings: {
            ...
            option: {
                ...
                organizeMenu: {
                    label: "Organise Menu",
                    description: "Organises the settings cog context menu into categories"
                },
                eagerLoad: {
                    label: "Eager Load",
        ...
        callTimer: {
            ...
            option: {
                ...
                allCallTimers: {
                    label: "All Call Timers",
                    description: "Show call timers for all users in servers"
                },
                showWithoutHover: {
                ...
                showRoleColor: {
                    label: "Show Role Colour",
                    description: "Display in the user’s role colour (if the ShowRoleColor plugin is enabled)"
                },
                trackSelf: {
        ...
        channelBadges: {
            ...
            option: {
                ...
                textBadgeColor: {
                    label: "Text Badge Colour",
                    description: "Text badge colour"
                },
                voiceBadgeColor: {
                    label: "Voice Badge Colour",
                    description: "Voice badge colour"
                },
                categoryBadgeColor: {
                ...
                announcementBadgeColor: {
                    label: "Announcement Thread Badge Colour",
                    description: "Announcement Thread badge colour"
                },
                ...
                publicThreadBadgeColor: {
                    label: "Public Thread Badge Colour",
                    description: "Public Thread badge colour"
                },
                privateThreadBadgeColor: {
                    label: "Private Thread Badge Colour",
                    description: "Private Thread badge colour"
                },
                stageBadgeColor: {
                    label: "Stage Badge Colour",
                    description: "Stage badge colour"
                },
                directoryBadgeColor: {
                    label: "Directory Badge Colour",
                    description: "Directory badge colour"
                },
                forumBadgeColor: {
                    label: "Forum Badge Colour",
                    description: "Forum badge colour"
                },
                mediaBadgeColor: {
                    label: "Media Badge Colour",
                    description: "Media badge colour"
                },
                nsfwBadgeColor: {
                    label: "NSFW Badge Colour",
                    description: "NSFW badge colour"
                },
                lockedBadgeColor: {
                    label: "Locked Badge Colour",
                    description: "Locked badge colour"
                },
                rulesBadgeColor: {
                    label: "Rules Badge Colour",
                    description: "Rules badge colour"
                },
                unknownBadgeColor: {
                    label: "Unknown Badge Colour",
                    description: "Unknown badge colour"
                }
            },
            badges: {
                text: "Text",
        ...
        channelTabs: {
            ...
            animation: {
                ...
                selectedBackground: "Selected Tab Background Colour",
            ...
            option: {
                ...
                noPomeloNames: {
                    ...
                    description: "Use display names instead of usernames for DMs"
                },
                showStatusIndicators: {
                    label: "Show Status Indicators",
                    description: "Show status indicators for DMs"
                },
                showBookmarkBar: {
                ...
                enableRapidNavigation: {
                    ...
                    description: "Enable rapid navigation behaviour - quickly navigating between channels will replace the current tab instead of creating new ones"
                },
                ...
                animationSelectedBackground: {
                    ...
                    description: "Enable background colour change for selected tabs"
                },
                animationTabShadows: {
                ...
                newTabButtonBehavior: {
                    label: "New Tab Button Behaviour",
        ...
        characterCounter: {
            ...
            option: {
                colorEffects: {
                    label: "Colour Effects",
                    description: "Turn on or off colour effects for getting close to the character limit"
                }
            }
        },
        cleanChannelGroups: {
        ...
        clientSideBlock: {
            ...
            option: {
                ...
                usersToBlock: {
                    ...
                    description: "User IDs separated by a comma and a space"
                },
                hideBlockedUsers: {
                    label: "Hide Blocked Users",
                    description: "Should blocked users also be hidden everywhere"
                },
                hideBlockedMessages: {
                    label: "Hide Blocked Messages",
                    description: "Should messages from blocked users be hidden fully (same as the old noblockedmessages plugin)"
                },
                hideEmptyRoles: {
        ...
        clientTheme: {
            name: "ClientTheme",
            description: "Recreation of the old client theme experiment. Add a colour to your Discord client theme",
            title: "Theme Colour",
            add: "Add a colour to your Discord client theme",
            option: {
                color: {
                    label: "Colour"
                },
        ...
        colorSighted: {
            name: "ColorSighted",
            description: "Removes the colourblind-friendly icons from statuses, just like 2015-2017 Discord"
        },
        commandPalette: {
            name: "CommandPalette",
            ...
            command: {
                ...
                updates: {
                    ...
                    changelog: {
                        ...
                        description: "Opens the Plexcord change log"
                    }
                },
                read: {
                    mark: {
        ...
        copyProfileColors: {
            ...
            description: "A plugin to copy people's profile gradient colours to clipboard.",
            copy: "Copy Profile Colours",
            toast: {
                noColor: "No profile colours found!",
                copied: "Profile colours copied to clipboard!",
                error: "Error copying profile colours!"
            }
        },
        copyStatusUrls: {
            name: "CopyStatusUrls",
            description: "Copy the user's status URL when you right-click it",
            toast: {
                copied: "Copied URL",
        ...
        ctrlEnterSend: {
            name: "CtrlEnterSend",
            description: "Use Ctrl+Enter to send messages (customisable)",
            option: {
                submitRule: {
                    label: "Submit Rule",
        ...
        cursorBuddy: {
            ...
            option: {
                ...
                speed: {
                    ...
                    invalid: "Speed must be greater than 0"
                },
                fps: {
                    label: "Framerate",
                    description: "Framerate of your buddy",
                    invalid: "Framerate must be greater than 0"
                },
                onekoSection: {
                    label: "Oneko"
                },
                furColor: {
                    label: "Fur Colour",
                    description: "Fur hex colour for Oneko"
                },
                outlineColor: {
                    label: "Outline Colour",
                    description: "Outline hex colour for Oneko"
                },
                fathorseSection: {
                    label: "Fatass Horse"
                },
        ...
        customFolderIcons: {
            ...
            description: "Customise folder icons with any PNG",
            option: {
                solidIcon: {
                    label: "Solid Icon",
            ...
            modal: {
                ...
                unset: "Unset",
                set: "Set a New Icon",
                hover: "You might have to hover over the folder after setting in order for it to refresh."
            }
        },
        customIdle: {
            name: "CustomIdle",
        ...
        customRPC: {
            ...
            button: "You can't see your own buttons on your profile, but everyone else can see them fine.",
            ...
            error: {
                ...
                streamCharacters: "Streaming link must be no longer than 512 characters.",
                ...
                tooLong: "Must be no longer than {{maxLength}} characters.",
        ...
        customSounds: {
            name: "CustomSounds",
            description: "Customise Discord's sounds.",
        ...
        customTimestamps: {
            ...
            option: {
                formats: {
                    label: "Formats",
                    description: "Customise the timestamp formats",
                },
                cozyFormat: {
                    label: "Cozy mode",
                ...
                compactFormat: {
                    label: "Compact mode",
                    description: "Time format on compact mode and hovering over messages"
                },
                tooltipFormat: {
                    label: "Tooltip",
        ...
        customUserColors: {
            ...
            description: "Lets you add a custom colour to any user, anywhere! Highly recommend to use with typingTweaks and roleColorEverywhere",
            option: {
                dmList: {
                    label: "DM List",
                    description: "Users with custom colours defined will have their name in the DM list coloured"
                },
                colorInServers: {
                    label: "Colour In Servers",
                    description: "If name colours should be changed within servers"
                }
            },
            context: {
                setColor: "Set Colour"
        ...
        declutter: {
            ...
            option: {
                ...
                removeProfileEffect: {
                    ...
                    description: "Remove profile animation effects on opening."
                },
                removeClanTag: {
                ...
                removeShopAboveDM: {
                    ...
                    description: "Remove shops above the DMs list."
                },
                removeQuestsAboveDM: {
                    label: "Remove Quests Above DMs",
                    description: "Remove quests above the DMs list."
                },
                miscHeader: {
                    label: "Misc"
                },
                ...
                removeAudioMenus: {
                    ...
                    description: "Remove menus next to the mute and deafen buttons."
                },
        ...
        decor: {
            name: "Decor",
            description: "Create and use your own custom avatar decorations, or pick your favourite from the presets.",
            ...
            guidelines: {
                hold: "Hold on",
                suspended: "By submitting a decoration, you agree to {{guidelines}}. Not reading these guidelines may result in your account being suspended from creating more decorations in the future.",
                guidelines: "the guidelines"
            }
        },
        demonstration: {
            ...
            option: {
                ...
                showConfirmationModal: {
                    ...
                    description: "Show a modal to remind you of the shortcut"
                }
            },
            switch: {
        ...
        devCompanion: {
            name: "DevCompanion",
            description: "Dev Companion plugin. Please report anything not working or behaving oddly (most likely a bug) to MutanPlex, either by ping or DM. Thanks!",
            reconnect: "Reconnect",
            option: {
                notifyOnAutoConnect: {
        ...
        disableCallIdle: {
            ...
            description: "Disables automatically being kicked from a DM voice call after 3 minutes and being moved to an AFK voice channel."
        },
        disableCameras: {
            name: "DisableCameras",
        ...
        discordDevBanner: {
            ...
            description: "Enables the Discord developer banner, which displays the Build ID",
        ...
        dragFavoriteEmotes: {
            ...
            description: "Adds drag-and-drop functionality to favourite emotes"
        },
        dragify: {
            name: "Dragify",
            ...
            option: {
                ...
                inviteMaxUses: {
                    ...
                    description: "Maximum uses for invite",
                    noLimit: "No Limit",
                    one: "1 Use",
                    five: "5 Uses",
                    ten: "10 Uses",
                ...
                reuseExistingInvites: {
                    ...
                    description: "Reuse an existing invite instead of creating a new one."
                },
                allowChatBodyDrop: {
        ...
        elementHighlighter: {
            ...
            toast: {
                copied: {
                    color: "Copied colour to clipboard!",
                }
            }
        },
        exitSounds: {
        ...
        exportMessages: {
            ...
            context: {
                ...
                exportAll: "Export all messages from {{user}}",
                user: "User",
        ...
        fakeNitro: {
            ...
            alert: {
                notice: {
                    title: "Hold on!",
                    body: "You are trying to send/edit a message that contains a FakeNitro emoji or sticker; however, you do not have permission to embed links in the current channel. Are you sure you want to send this message? Your FakeNitro items will appear as a link only.",
                ...
                apngSticker: {
                    title: "Hold on!",
                    body: "You cannot send this message because it contains an animated FakeNitro sticker, and you do not have permission to attach files in the current channel. Please remove the sticker to proceed."
                }
            }
        },
        fakeProfileThemes: {
            name: "FakeProfileThemes",
            description: "Allows profile theming by hiding the colours in your bio thanks to invisible 3y3 encoding",
            button: {
                copy: "Copy 3y3"
            },
            modal: {
                usage: "Usage",
                preview: "Preview",
                intro: "After enabling this plugin, you will see custom colours in the profiles of other people using compatible plugins.",
                setColor: "To set your own colours:",
                step1: "• Use the colour pickers below to choose your colours",
                step2: "• Click the {{copy}} button",
                step3: "• Paste the invisible text anywhere in your bio",
                pickers: "Colour Pickers",
                primary: "Primary",
                accent: "Accent"
            },
            option: {
                nitroFirst: {
                    label: "Nitro First",
                    description: "Default colour source if both are present",
                    nitro: "Nitro colours",
                    fake: "Fake colours"
                }
            }
        ...
        fakeProfileThemesAndEffects: {
            ...
            description: "Allows profile theming and profile effects by hiding the colours and effects in your bio thanks to invisible 3y3 encoding",
            option: {
                prioritizeNitro: {
                    label: "Prioritise Nitro",
                    description: "Source to prioritise",
                    nitro: "Nitro",
                    aboutMe: "About me"
                },
                hideBuilder: {
            ...
            modal: {
                ...
                usage: {
                    title: "Usage",
                    intro: "After enabling this plugin, you will see custom theme colours and effects in the profiles of others using this plugin.",
                    setColor: "To set your own colours and effect:",
                    step1: "Go to your profile settings",
                    step2: "Use the FPTE Builder to choose your profile theme colours and effect",
        ...
        fastDeleteChannels: {
            ...
            option: {
                ...
                reqCtrl: {
                    ...
                    description: "Require the Control key to be held."
                },
                reqShift: {
                    label: "Require Shift",
                    description: "Require the Shift key to be held."
                },
                reqAlt: {
                    label: "Require Alt",
                    description: "Require the Alt key to be held."
                }
            }
        },
        favoriteEmojiFirst: {
            name: "FavouriteEmojiFirst",
            description: "Puts your favourite emoji first in the emoji autocomplete and also provides emoji aliases.",
            option: {
                aliases: {
                    label: "Aliases",
            ...
            modal: {
                clear: {
                    ...
                    description: "This will remove every emoji alias you have saved.",
        ...
        favoriteGifSearch: {
            ...
            description: "Adds a search bar to favourite GIFs.",
            placeholder: "Search favourite GIFs",
            option: {
                searchOption: {
                    label: "Search Option",
        ...
        fileDownloadButton: {
            ...
            description: "Adds a Download button to the top right corner of files"
        },
        findReply: {
            name: "FindReply",
        ...
        fixCodeblockGap: {
            ...
            description: "Removes the gap between codeblocks and the text below them"
        },
        fixFileExtensions: {
        ...
        fixImagesQuality: {
            ...
            description: "Improves the quality of images by forcing the original source to be used",
            option: {
            ...
            modal: {
                about: {
                    ...
                    body3: "You can also enable original images in chat, but beware of the following caveats:",
        ...
        followUser: {
            ...
            option: {
                ...
                channelFull: {
                    label: "Channel Full",
                    description: "Attempt to move you to the channel when it is no longer full"
                }
            },
            toast: {
                channelFull: "Channel is full",
                newVc: "Followed user into a new voice channel",
                insufficientPermissions: "Insufficient permissions to enter the voice channel",
        ...
        forwardAnywhere: {
            ...
            option: {
                forwardPreface: {
                    ...
                    description: "What should forwarded content be prefaced with"
                }
            },
            context: {
                attachments: "Attachments",
        ...
        friendCloud: {
            name: "FriendCloud",
            description: "Adds a /friendcloud command to visualise the users you most interact with",
            command: {
                friendcloud: {
                    description: "Visualise your friend cloud",
        ...
        friendCodes: {
            name: "FriendCodes",
            description: "Generate friend codes to easily add friends",
            card: {
        ...
        friendTags: {
            ...
            modal: {
                name: "Name",
                users: "Users (separated by comma)",
        ...
        fullUserInChatbox: {
            ...
            description: "Makes user mentions in the chatbox have more functionalities, like left/right clicking"
        },
        fullVCPFP: {
            name: "FullVCPFP",
        ...
        gameActivityToggle: {
            ...
            option: {
                oldIcon: {
                    label: "Old Icon",
                    description: "Use the old icon style from before the Discord icon redesign"
                },
                location: {
                    label: "Location",
        ...
        gifCollections: {
            ...
            option: {
                ...
                showCopyImageLink: {
                    ...
                    description: "Show the {{copyImageLink}} option in context menus"
                },
                preventDuplicates: {
            ...
            modal: {
                ...
                rename: {
                    ...
                    warning: "Name cannot be longer than 24 characters",
                    rename: "Rename"
                }
            },
            alert: {
        ...
        gifPaste: {
            name: "GifPaste",
            description: "Allows you to paste GIFs directly into the chat box"
        },
        gifRoulette: {
            name: "GifRoulette",
            description: "Adds a command to send a random GIF from your favourites, with a one in ten chance to ping the owner of the server",
            command: {
                gifRoulette: {
            ...
            option: {
                pingOwnerChance: {
                    ...
                    description: "Whether there should be a 1 in 10 chance to ping the owner of the guild (oh no)"
                }
            }
        },
        gitHubRepos: {
        ...
        googleThat: {
            ...
            option: {
                hyperlink: {
                    label: "Hyperlink",
                    description: "Whether the sent link should hyperlink with the query as the label"
                },
                embed: {
                    label: "Embed",
                    description: "Whether the sent link should render an embed"
                },
                defaultEngine: {
        ...
        hideChatButtons: {
            ...
            option: {
                color: {
                    label: "Colour",
                    description: "Colour it red on opening"
                },
                open: {
                    label: "Open",
        ...
        iconViewer: {
            ...
            about: {
                ...
                list: {
                    ...
                    search: "Search for colours by right-clicking the colour name",
        ...
        idleAutoRestart: {
            ...
            description: "Automatically restarts the client after being idle for a configurable amount of time, but avoids restarting whilst you are in VC.",
            option: {
                isEnabled: {
                    label: "Is Enabled",
        ...
        ignoreActivities: {
            ...
            option: {
                ...
                listMode: {
                    ...
                    blacklist: "Blacklist (ignore only what is in the list)",
                    whitelist: "Whitelist (ignore everything except what is in the list)"
                },
                idList: {
                    label: "IDs List"
                },
        ...
        imageLink: {
            name: "ImageLink",
            description: "Never hide image links in messages, even if it is the only content"
        },
        imageZoom: {
            name: "ImageZoom",
        ...
        imgToGif: {
            name: "ImgToGif",
            description: "Adds an /imgtogif slash command to create a GIF from any image",
            command: {
                imgToGif: {
                    description: "Allows you to turn an image into a GIF",
        ...
        inRole: {
            ...
            modal: {
                about: {
                    title: "Limitations",
                    description: "If you do not have mod permissions on the server, and that server is large (over 100 members), the plugin may be limited in the following ways",
                    list: {
        ...
        invisibleChat: {
            ...
            option: {
                savedPasswords: {
                    ...
                    description: "Saved passwords (separated with a , )"
                }
            },
            button: {
        ...
        ircColors: {
            name: "IrcColors",
            description: "Makes username colours in chat unique, like in IRC clients",
            option: {
                lightness: {
                    label: "Lightness",
                    description: "Lightness, in %. Change if the colours are too light or too dark"
                },
                memberListColors: {
                    label: "Member List Colours",
                    description: "Replace role colours in the member list"
                },
                applyColorOnlyToUsersWithoutColor: {
                    label: "Apply Colour Only to Users Without Colour",
                    description: "Apply colours only to users who don't have a predefined colour"
                },
                applyColorOnlyInDms: {
                    label: "Apply Colour Only in DMs",
                    description: "Apply colours only in direct messages; do not apply colours in servers."
                }
            }
        },
        iRememberYou: {
            name: "IRememberYou",
            description: "Locally saves everyone you've been communicating with (including servers), in case of loss",
            section: {
                description: "Provides a list of users you have mentioned or replied to, or those who own the servers you belong to (server owner*), or are members of your guild",
                empty: "It is empty right now.",
        ...
        messageColors: {
            name: "MessageColors",
            description: "Displays colour codes like #FF0042 inside of messages",
            option: {
                renderType: {
                    label: "Render Type",
                    description: "How to render colours",
                ...
                blockView: {
                    ...
                    description: "How to display colour blocks",
                    right: "Right side",
                    left: "Left side",
                    both: "Both sides"
                }
        ...
        messageFetchTimer: {
            ...
            option: {
                ...
                iconColor: {
                    label: "Icon Colour",
                    description: "Icon colour (CSS colour value)"
                }
            },
        ...
        messageLinkEmbeds: {
            ...
            option: {
                messageBackgroundColor: {
                    label: "Message Background Colour",
                    description: "Background colour for messages in rich embeds"
                },
                automodEmbeds: {
        ...
        messageLoggerEnhanced: {
            ...
            context: {
                ...
                fromUsernameDm: "From {{username}}'s DMs",
            ...
            modal: {
                ...
                empty: "Empty eh",
                importLogs: "ML Enhanced now stores logs in indexeddb. You need to import your old logs from the logs directory. Importing won't overwrite existing logs"
            },
            clear: {
                title: "Clear Logs",
            ...
            option: {
                ...
                permanentlyRemoveLogByDefault: {
                    ...
                    description: "Base MessageLogger remove log button will delete logs permanently"
                },
        ...
        messageTags: {
            ...
            notExist: "The tag **{{tagname}}** does not exist anymore! Please reload your Discord to fix :)",
        ...
        moreCommands: {
            ...
            command: {
                ...
                transform: {
                    ...
                    normalize: {
                        description: "Text normalisation form",
                        nfc: "Normalisation Form C (NFC)",
                        nfd: "Normalisation Form D (NFD)",
                        nfkc: "Normalisation Form KC (NFKC)",
                        nfkd: "Normalisation Form KD (NFKD)"
                    },
        ...
        musicControls: {
            ...
            option: {
                ...
                lyricsConversion: {
                    ...
                    description: "Automatically translate or romanise lyrics",
                    none: "None",
                    translate: "Translate",
                    romanize: "Romanise"
                },
        ...
        neverPausePreviews: {
            ...
            description: "Prevents in-call/PiP previews (screen share, streams, etc.) from pausing even if the client loses focus",
            about: "This plugin will cause Discord to use more resources than usual"
        },
        newGuildSettings: {
        ...
        noBlockedMessages: {
            ...
            option: {
                ...
                defaultHideUsers: {
                    ...
                    description: "If enabled, messages from blocked users will be completely hidden and any messages from user IDs in the override list will be collapsed (default Discord behaviour) instead. If disabled, messages from blocked users will be collapsed and any messages from user IDs in the override list will be completely hidden instead."
                },
                overrideUsers: {
                    label: "Override Users",
                    description: "Comma-separated list of user IDs which will be hidden or collapsed instead of the default behaviour selected above."
                }
            }
        },
        noBulletPoints: {
        ...
        noDeepLinks: {
            ...
            description: "Disables Discord's redundant deep linking feature which tries to force you to use their Desktop App"
        },
        noDeleteSafety: {
            name: "NoDeleteSafety",
            description: "Removes the 'enter server name' requirement when deleting a server",
        ...
        noMaskedUrlPaste: {
            ...
            description: "Pasting a link whilst having text selected will not paste as a masked URL"
        },
        noMirroredCamera: {
        ...
        onePingPerDM: {
            ...
            option: {
                ...
                alwaysPlaySound: {
                    ...
                    description: "Play the message notification sound even when it's disabled"
                }
            }
        },
        openInApp: {
        ...
        partyMode: {
            name: "PartyMode",
            description: "Allows you to use party mode because the party never ends ✨",
            option: {
        ...
        pauseInvitesForever: {
            ...
            description: "Brings back the option to pause invites indefinitely that Discord redundantly removed.",
        ...
        permissionsViewer: {
            ...
            option: {
                permissionsSortOrder: {
                    ...
                    description: "The sort method used for defining which role grants a user a certain permission",
        ...
        petpet: {
            ...
            command: {
                petpet: {
                    ...
                    resolution: "Resolution for the GIF. Defaults to 120. If you enter an insane number and it freezes Discord, that is your fault.",
                    image: "Image attachment to use",
            ...
            error: {
                ...
                fetchImageFailed: "An error occurred whilst loading {{url}}. Check the console for more info."
            }
        },
        pictureInPicture: {
        ...
        pinDMs: {
            ...
            option: {
                ...
                canCollapseDmSection: {
                    ...
                    description: "Allow uncategorised DMs section to be collapsible"
                },
                dmSectionCollapsed: {
        ...
        pingNotifications: {
            ...
            description: "Customisable notifications with improved mention formatting",
            option: {
                friends: {
                    label: "Friends",
        ...
        plainFolderIcon: {
            ...
            description: "Do not show the small guild icons in folders"
        },
        platformIndicators: {
            ...
            option: {
                ...
                colorMobileIndicator: {
                    label: "Colour Mobile Indicator",
                    description: "Whether to make the mobile indicator match the colour of the user status."
                },
                showBots: {
                    label: "Show Bots",
        ...
        platformSpoofer: {
            ...
            about: "We cannot guarantee this plugin won't get you warned or banned.",
            platform: {
        ...
        polishWording: {
            ...
            option: {
                ...
                blockedWords: {
                    label: "Blocked Words",
                    description: "Words that will not be capitalised (comma separated)."
                },
                fixApostrophes: {
                ...
                fixCapitalization: {
                    ...
                    description: "Capitalise sentences."
                },
                fixPunctuation: {
                ...
                fixPunctuationFrequency: {
                    ...
                    description: "Percentage period frequency (this majorly annoys some people).",
                }
            }
        },
        previewMessage: {
        ...
        questify: {
            ...
            settings: {
                ...
                restyleQuests: {
                    ...
                    description: "Highlight Quests with optional theme colours for visibility.",
            ...
            option: {
                ...
                questButtonBadgeColor: {
                    label: "Quest Button Badge Colour",
                    description: "The colour of the Quest button badge in the server list."
                },
                ...
                restyleQuests: {
                    ...
                    description: "Customise the appearance of Quest tiles in the Quests page."
                },
                restyleQuestsUnclaimed: {
                    label: "Restyle Quests Unclaimed",
                    description: "The colour of unclaimed Quest tiles in the Quests page."
                },
                restyleQuestsClaimed: {
                    label: "Restyle Quests Claimed",
                    description: "The colour of claimed Quest tiles in the Quests page."
                },
                restyleQuestsIgnored: {
                    label: "Restyle Quests Ignored",
                    description: "The colour of ignored Quest tiles in the Quests page."
                },
                restyleQuestsExpired: {
                    label: "Restyle Quests Expired",
                    description: "The colour of expired Quest tiles in the Quests page."
                },
            ...
            reward: {
                ...
                unrecognized: "{{completingText}} for an unrecognised reward type."
            },
            notification: {
                completed: {
        ...
        quickReply: {
            ...
            option: {
                ...
                ignoreBlockedAndIgnored: {
                    label: "Ignore Blocked And Ignored",
        ...
        quoter: {
            ...
            option: {
                ...
                grayscale: {
                    label: "Greyscale",
                    description: "Enable greyscale by default"
                },
                showWatermark: {
        ...
        randomVoice: {
            ...
            option: {
                ...
                selfMute: {
                    label: "Auto Mute",
                    description: "Automatically mutes your mic when joining a voice channel."
                },
                selfDeafen: {
                    label: "Auto Deafen",
                    description: "Automatically deafens your audio when joining a voice channel."
                },
                leaveEmpty: {
        ...
        recentDMSwitcher: {
            ...
            option: {
                visualStyle: {
                    label: "Visual Style",
                    description: "Visual indicator style whilst cycling",
                ...
                toastDurationMs: {
                    ...
                    description: "Duration of the status message"
                },
                clearRdms: {
        ...
        relationshipNotifier: {
            ...
            option: {
                ...
                offlineRemovals: {
                    ...
                    description: "Notify you when starting Discord if you were removed whilst offline."
                },
                friends: {
                    label: "Friends",
        ...
        repeatMessages: {
            name: "RepeatMessages",
            description: "Allows you to repeat messages quickly. If you hold Shift whilst clicking the Repeat option, it will reply to the message.",
        ...
        reviewDB: {
            name: "ReviewDB",
            description: "Review other users (Adds a new section to profiles)",
            notification: {
                newReview: "You have new reviews on your profile!",
                auth: {
                    error: "An error occurred whilst authorising",
                    successfully: "Successfully logged in!",
                    failed: "Failed to authorise",
                    review: "Please authorise to add a review.",
                    opening: "Opening authorisation window...",
                    need: "You need to authorise to review users!"
                },
                error: {
                    fast: "You are sending requests too fast. Wait a few seconds and try again.",
                    fetching: "An error occurred whilst fetching reviews.",
                    action: {
            ...
            modal: {
                ...
                report: {
                    title: "Are you sure?",
                    description: "Do you really want to report this review?",
                    confirm: "Report",
                    cancel: "Never mind",
                ...
                block: {
                    title: "Are you sure?",
                    description: "Do you really want to block this user? You will not see their reviews anymore.",
                    confirm: "Block",
                    cancel: "Never mind",
                ...
                blocked: {
                    ...
                    fetch: "An error occurred whilst fetching blocked users."
                },
                reviews: {
                    title: "'s Reviews",
            ...
            option: {
                authorize: {
                    label: "Authorise",
                    button: "Authorise with ReviewDB"
                },
                notifyReviews: {
        ...
        roleColorEverywhere: {
            ...
            description: "Adds the top role colour anywhere possible",
            option: {
                chatMentions: {
                    label: "Chat Mentions",
                    description: "Show role colours in chat mentions (including in the message box)"
                },
                memberList: {
                    label: "Member List",
                    description: "Show role colours in member list role headers"
                },
                voiceUsers: {
                    label: "Voice Users",
                    description: "Show role colours in the voice chat user list"
                },
                reactorsList: {
                    label: "Reactors List",
                    description: "Show role colours in the reactors list"
                },
                pollResults: {
                    label: "Poll Results",
                    description: "Show role colours in the poll results"
                },
                colorChatMessages: {
                    label: "Colour Chat Messages",
                    description: "Colour chat messages based on the author's role colour"
                },
                messageSaturation: {
                    label: "Message Saturation",
                    description: "Intensity of message colouring"
                }
            }
        },
        rpcEditor: {
        ...
        saveFavoriteGIFs: {
            ...
            description: "Export favourited GIF URLs",
            toolbox: "Save Favourited GIFs",
            title: "Save Favourited GIFs",
            command: {
                savegifs: {
                    description: "Save all favourited GIF URLs to a text file"
                },
                saveworkinggifs: {
                    description: "Test all favourited GIFs and only save the ones that are still working"
                }
            },
            option: {
                showToolboxButton: {
                    label: "Show Toolbox Button",
                    description: "Show 'Save Favourited GIFs' button in Plexcord Toolbox (Requires Reload)"
                }
            },
            toast: {
                save: "Saved GIFs successfully as {{filename}}",
                failed: "Failed to save GIFs",
                no: "No favourited GIFs found!",
        ...
        searchFix: {
            ...
            paragraph3: "This plugin just jumps to the opposite sorting method to try to get around Discord's restriction,",
        ...
        sendTimestamps: {
            ...
            sample: {
                paragraph1: "To quickly send time-only timestamps, include timestamps formatted as `HH:MM` (including the backticks!) in your message",
        ...
        shikiCodeblocks: {
            ...
            description: "Brings VS Code-style codeblocks into Discord, powered by Shiki",
            option: {
                theme: {
                    label: "Theme",
                ...
                customTheme: {
                    label: "Custom Theme",
                    description: "A link to a custom VS Code theme",
        ...
        showAllMessageButtons: {
            ...
            description: "Always show all message buttons regardless of whether you are holding the shift key or not.",
            option: {
                noShiftDelete: {
        ...
        showMeYourName: {
            ...
            option: {
                ...
                truncateAllNamesWithStreamerMode: {
                    ...
                    description: "Truncate all names, not just usernames, whilst in Streamer Mode."
                },
                removeDuplicates: {
                ...
                ignoreGradients: {
                    ...
                    description: "For the non-primary names, if the role has a gradient and the colour below is set to 'Role+-#', use the primary colour instead of the whole gradient, and if it has a Nitro effect, ignore it entirely."
                },
                animateGradients: {
                ...
                customNameColor: {
                    label: "Custom Name Colour",
                    description: "The colour to use for the custom name you assigned a user if it's not the first displayed. Accepts any valid CSS input. Use 'Role' to follow the user's top role colours, Nitro effect colours, or IRCColors colour if enabled. Use 'Role+-#' to adjust the brightness by that percentage (e.g. 'Role+15')"
                },
                friendNameColor: {
                    label: "Friend Name Colour",
                    description: "The colour to use for a friend's nickname if it's not the first displayed. Accepts any valid CSS input. Use 'Role' to follow the user's top role colours, Nitro effect colours, or IRCColors colour if enabled. Use 'Role+-#' to adjust the brightness by that percentage (e.g. 'Role+15')"
                },
                nicknameColor: {
                    label: "Nickname Colour",
                    description: "The colour to use for the nickname if it's not the first displayed. Accepts any valid CSS input. Use 'Role' to follow the user's top role colours, Nitro effect colours, or IRCColors colour if enabled. Use 'Role+-#' to adjust the brightness by that percentage (e.g. 'Role+15')"
                },
                displayNameColor: {
                    label: "Display Name Colour",
                    description: "The colour to use for the display name if it's not the first displayed. Accepts any valid CSS input. Use 'Role' to follow the user's top role colours, Nitro effect colours, or IRCColors colour if enabled. Use 'Role+-#' to adjust the brightness by that percentage (e.g. 'Role+15')"
                },
                usernameColor: {
                    label: "Username Colour",
                    description: "The colour to use for the username if it's not the first displayed. Accepts any valid CSS input. Use 'Role' to follow the user's top role colours, Nitro effect colours, or IRCColors colour if enabled. Use 'Role+-#' to adjust the brightness by that percentage (e.g. 'Role+15')"
                },
                triggerNameRerender: {
        ...
        sidebarChat: {
            name: "SidebarChat",
            description: "Open another channel or a DM as a sidebar or as a popout",
            toolbox: {
            ...
            option: {
                ...
                patchCommunity: {
                    ...
                    description: "Patch features like the Channel Browser or Members tab that community servers have."
                }
            }
        },
        signature: {
        ...
        snowfall: {
            ...
            about: {
                title: "Information",
                paragraph: "This plugin adds a Christmassy snowfall effect on top of Discord's interface. You can change the type of snow in the settings below.",
                note: "NOTE: Whilst on most computers this plugin will not impact performance any more than your average Plexcord extension, it may cause some lag on lower-end systems."
            },
            option: {
                typeOfSnow: {
                    label: "Type of Snow",
        ...
        soundBoardLogger: {
            ...
            option: {
                savedIds: {
                    ...
                    cantDecimal: "The value cannot be a decimal number.",
                    cantNegative: "The value cannot be a negative number.",
                ...
                fileType: {
                    label: "File Type",
                    description: "The format in which you want to save your file"
                },
                openLogs: {
                    label: "Open Logs",
        ...
        stickerPaste: {
            name: "StickerPaste",
            description: "Makes picking a sticker in the sticker picker insert it into the chatbox instead of instantly sending it"
        },
        ...
        streamingCodecDisabler: {
            ...
            option: {
                disableAv1Codec: {
                    ...
                    description: "Prevent Discord from considering using AV1 for streaming."
                },
                disableH265Codec: {
                    label: "Disable H265 Codec",
                    description: "Prevent Discord from considering using H265 for streaming."
                },
                disableH264Codec: {
                    label: "Disable H264 Codec",
                    description: "Prevent Discord from considering using H264 for streaming."
                },
                disableVP8Codec: {
                    label: "Disable VP8 Codec",
                    description: "Prevent Discord from considering using VP8 for streaming."
                },
                disableVP9Codec: {
                    label: "Disable VP9 Codec",
                    description: "Prevent Discord from considering using VP9 for streaming."
                }
            }
        },
        superReactionTweaks: {
            name: "SuperReactionTweaks",
            description: "Customise the limit of Super Reactions playing at once, and Super React by default",
            option: {
                superReactByDefault: {
                ...
                superReactionPlayingLimit: {
                    ...
                    description: "Max Super Reactions to play at once. Set to 0 to disable playing Super Reactions"
                }
            }
        },
        textReplace: {
        ...
        toggleVideoBind: {
            ...
            description: "Adds a customisable bind to toggle webcam.",
            option: {
                keyBind: {
                    label: "Keybind",
        ...
        typingTweaks: {
            ...
            option: {
                ...
                showRoleColors: {
                    label: "Show Role Colours",
                    description: "Show role colours in the typing indicator"
                },
        ...
        viewIcons: {
            name: "ViewIcons",
            description: "Makes avatars and banners in user profiles clickable, adds View Avatar/Banner entries in the user, server and group channel context menu.",
            context: {
                view: {
                    avatar: "View Avatar",
        ...
        voiceButtons: {
            ...
            option: {
                ...
                muteSoundboard: {
                    ...
                    description: "Toggles their soundboard upon clicking the Deafen button."
                },
                disableVideo: {
                    label: "Disable Video",
                    description: "Toggles their video upon clicking the Deafen button."
                },
                useServer: {
                    label: "Use Server",
                ...
                showButtonsSelf: {
                    ...
                    description: "Whether you want to display buttons for your own user. Same functionality as other button(s) except it'll open the DMs panel and mute/deafen for yourself upon clicking button(s).",
                    display: "Display",
                    hide: "Hide",
                    disable: "Disable"
                },
        ...
        webContextMenus: {
            ...
            description: "Re-adds context menus missing in the web version of Discord: Links & Images (Copy/Open Link/Image), Text Area (Copy, Cut, Paste, Spell Check)",
            option: {
                addBack: {
                    label: "Add Back",
        ...
        writeUpperCase: {
            ...
            option: {
                blockedWords: {
                    label: "Blocked Words",
                    description: "Strings not to capitalise (separate with a comma)"
                }
            }
        },
        xSOverlay: {
            ...
            option: {
                ...
                pingColor: {
                    label: "Ping Colour",
                    description: "User mention colour"
                },
                channelPingColor: {
                    label: "Channel Ping Colour",
                    description: "Channel mention colour"
                },
                soundPath: {
                    label: "Sound Path",
        ...
        youtubeAdblock: {
            name: "YouTubeAdblock",
            description: "Block ads in YouTube embeds and the Watch Together activity via AdGuard"
        },
        youtubeDescription: {
