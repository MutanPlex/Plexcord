...
const translations: MatchStructure<typeof enTranslations> = {
    ...
    plugin: {
        ...
        favouriteAnything: {
            ...
            description: "收藏任何圖像",
            noFiles: "沒有與您的搜尋符合的檔案。",
            searchPlaceholder: "搜尋檔案",
            media: "媒體",
            demoText: "點擊星號來收藏檔案。\n收藏的檔案將顯示在這裡！",
            fetchError: "無法取得 {filename}",
            uploadError: "無法上傳 {filename}"
        },
        fileDownloadButton: {
        ...
        sidebarChat: {
            ...
            modal: {
                switch: "切換頻道",
                popout: "彈出聊天視窗",
                popoutClose: "關閉彈出聊天視窗",
                popoutFor: "為 {{channel}} 彈出聊天視窗",
                close: "關閉側邊欄聊天"
            },
            option: {
                persistSidebar: {
                ...
                persistPopoutWindows: {
                    label: "保留彈出聊天視窗",
                    description: "Discord 重新啟動後還原已開啟的彈出聊天視窗"
                },
                popoutAlwaysOnTop: {
                    label: "彈出視窗置頂",
                    description: "讓彈出聊天視窗保持在所有其他視窗之上。"
                },
                patchCommunity: {
                    label: "補丁社區",
        ...
        streamingCodecDisabler: {
            ...
            option: {
                ...
                disableVP8Codec: {
                    label: "停用 VP8 編解碼器",
                    description: "防止 Discord 考慮使用 VP8 進行串流傳輸。"
                },
                disableVP9Codec: {
                    label: "停用 VP9 編解碼器",
                    description: "防止 Discord 考慮使用 VP9 進行串流傳輸。"
                }
            }
        },
        superReactionTweaks: {
