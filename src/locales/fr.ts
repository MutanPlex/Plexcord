    ...
    plugin: {
        ...
        gitHubRepos: {
            ...
            option: {
                ...
                showInMiniProfile: {
                    label: "Afficher dans le mini-profil",
                    description: "Affiche les dépôts dans l'aperçu de profil"
                },
                showRepositoryTab: {
        ...
        textReplace: {
            ...
            option: {
                replace: {
                    label: "Remplacer",
                    string: "Via chaîne de caractères",
                    regex: "Via Regex",
            ...
            modal: {
                ...
                find: "Chercher",
                replace: "Remplacer",
                includes: "Seulement si contient",
                type: "Tapez un message",
                applied: "Message après application des règles"
            }
        },
        themeAttributes: {
