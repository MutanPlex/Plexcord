        ...
        metadata: {
            api: {
                description: {
                    ...
                    profileCollections: "API permettant d'ajouter des collections au panneau de profil utilisateur, comme la collection de jeux de Discord."
                },
                chatButtons: {
                    context: {
                        buttons: "Boutons"
    ...
    plugin: {
        ...
        messageLogger: {
            ...
            option: {
                ...
                ignoreSelfEdits: {
                    label: "Ignorer ses propres modifications",
                    description: "Indique s'il faut ignorer vos propres modifications"
                },
                ignoreUsers: {
        ...
        messageLoggerEnhanced: {
            ...
            option: {
                ...
                clearLogsOnRestart: {
                    label: "Effacer les journaux au redémarrage",
                    description: "Efface les journaux lorsque Discord redémarre."
                },
                openLogs: {
        ...
        musicControls: {
            ...
            option: {
                ...
                websocketURL: {
                    label: "URL Websocket",
                    description: "Par défaut : ws://localhost:24123"
                },
                YtmSectionTitle: {
                    label: "YouTube Music",
                ...
                spotifyLyricsApiUrl: {
                    label: "URL de l'API Spotify Lyrics",
                    description: "URL de base de l'API de paroles Spotify."
                },
                translateTo: {
                    label: "Traduire vers",
        ...
        randomVoice: {
            ...
            context: {
                ...
                voice: {
                    ...
                    joinSettings: "Paramètres de connexion",
                    auto: {
                        mute: "Muet auto",
            ...
            option: {
                ...
                prioritizeFriends: {
                    label: "Prioriser les amis",
                    description: "Préférer les salons où se trouvent vos amis si possible."
                },
                avoidStages: {
        ...
        streamingCodecDisabler: {
            ...
            option: {
                ...
                disableVP8Codec: {
                    label: "Désactiver le codec VP8",
                    description: "Empêche Discord d'utiliser le codec VP8."
                },
                disableVP9Codec: {
                    label: "Désactiver le codec VP9",
                    description: "Empêche Discord d'utiliser le codec VP9."
                }
            }
        },
        superReactionTweaks: {
