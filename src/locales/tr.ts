    ...
    plugin: {
        ...
        customSounds: {
            ...
            type: {
                ...
                mention1: "Bahsetme 1 (@role)",
                mention2: "Bahsetme 2 (@everyone)",
                mention3: "Bahsetme 3 (@here)",
                message1: "Mesaj 1 (Genel)",
                message2: "Mesaj 2 (Sunucuda Yanıt)",
                message3: "Mesaj 3 (DM'ler ve Grup DM'leri)",
                mute: "Sessize Al",
        ...
        musicControls: {
            ...
            option: {
                ...
                websocketURL: {
                    label: "Websocket URL",
                    description: "Varsayılan: ws://localhost:24123"
                },
                YtmSectionTitle: {
                    label: "YouTube Music",
        ...
        streamingCodecDisabler: {
            ...
            option: {
                ...
                disableVP8Codec: {
                    label: "VP8 Codec'ini Devre Dışı Bırak",
                    description: "Discord'un yayın için VP8 kullanmayı düşünmesini engeller."
                },
                disableVP9Codec: {
                    label: "VP9 Codec'ini Devre Dışı Bırak",
                    description: "Discord'un yayın için VP9 kullanmayı düşünmesini engeller."
                }
            }
        },
        superReactionTweaks: {
