    ...
    plugin: {
        ...
        betterAudioPlayer: {
            ...
            option: {
                ...
                forceMoveBelow: {
                    ...
                    description: "Forçar o visualizador a ficar abaixo dos controles de áudio"
                }
            },
            toast: {
        ...
        crashHandler: {
            ...
            toast: {
                crashed: {
                    ...
                    body: "Poxa :( O Discord travou duas vezes seguidas rapidamente, não tentando recuperar. Clique aqui para entrar no nosso servidor de suporte!",
                    ...
                    recover: "Tentando recuperar... Clique aqui para entrar no nosso servidor de suporte!",
                    invalid: "Link de convite inválido ou expirado."
                }
            }
        },
        ...
        fullVCPFP: {
            ...
            option: {
                useServerProfileAvatars: {
                    label: "Usar Avatares do Perfil do Servidor",
                    description: "Usa os avatares do perfil do servidor em canais de voz de servidores quando disponível."
                }
            }
        },
        gameActivityToggle: {
        ...
        gitHubRepos: {
            ...
            option: {
                ...
                showInMiniProfile: {
                    label: "Mostrar no Mini Perfil",
                    description: "Mostra os repositórios no popout de mini perfil"
                },
                showRepositoryTab: {
                    label: "Mostrar Aba de Repositórios",
                    description: "Mostra a aba de repositórios no modal de perfil (oculta o botão em conexões quando ativado)"
                }
            },
            error: {
                error: "Erro",
