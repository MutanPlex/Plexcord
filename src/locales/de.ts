    ...
    plugin: {
        ...
        gitHubRepos: {
            ...
            option: {
                ...
                showInMiniProfile: {
                    label: "Im Mini-Profil anzeigen",
                    description: "Zeigt Repositories im kleinen Profil-Popout an"
                },
                showRepositoryTab: {
                    label: "Repository-Tab anzeigen",
                    description: "Zeigt den Repository-Tab im Profil-Modal an (blendet den Button in den Verbindungen aus, wenn aktiviert)"
                }
            },
            error: {
                error: "Fehler",
        ...
        textReplace: {
            ...
            option: {
                replace: {
                    label: "Ersetzen",
                    string: "String verwenden",
                    regex: "Regex verwenden",
            ...
            modal: {
                ...
                find: "Suchen",
                replace: "Ersetzen",
                includes: "Nur wenn enthalten",
                type: "Schreibe eine Nachricht",
