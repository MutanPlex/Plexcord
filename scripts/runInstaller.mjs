...
const BASE_URL = "https://github.com/Plexcord/Installer/releases/latest/download/";
const INSTALLER_PATH_DARWIN = "PlexcordInstaller.app/Contents/MacOS/PlexcordInstaller";
...
function getFilename() {
    switch (process.platform) {
        case "win32":
            return "PlexcordInstallerCli.exe";
        case "darwin":
            return "PlexcordInstaller.MacOS.zip";
        case "linux":
            return "PlexcordInstallerCli-linux";
        default:
...
async function ensureBinary() {
    ...
    const outputFile = process.platform === "darwin"
        ? join(FILE_DIR, "PlexcordInstaller")
        : downloadName;
    ...
    const res = await fetch(BASE_URL + filename, {
        headers: {
            "User-Agent": "Plexcord (https://github.com/MutanPlex/Plexcord)",
            "If-None-Match": etag
        }
    });
    ...
    if (process.platform === "darwin") {
        ...
        logAndRun(`sudo spctl --add '${outputFile}' --label "Plexcord Installer"`);
