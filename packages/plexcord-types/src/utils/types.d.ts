...
import { FluxEvents } from "../webpack/common/types";
import { ReactNode } from "react";
import { Promisable } from "type-fest";
export default function definePlugin<P extends PluginDef>(p: P & Record<string, any>): P & Record<string, any>;
...
export declare const enum StartAt {
    /** Right away, as soon as Plexcord initialised */
    Init = "Init",
...
export type PluginSettingDef = (PluginSettingCommon & PluginSettingCustomDef & Pick<PluginSettingCommon, "onChange">) | (PluginSettingComponentDef & Omit<PluginSettingCommon, "description" | "placeholder">) | ((PluginSettingStringDef | PluginSettingNumberDef | PluginSettingBooleanDef | PluginSettingSelectDef | PluginSettingSliderDef | PluginSettingBigIntDef) & PluginSettingCommon);
...
export interface DefinedSettings<Def extends SettingsDefinition = SettingsDefinition, Checks extends SettingsChecks<Def> = {}, PrivateSettings extends object = {}> {
    /** Shorthand for `Plexcord.Settings.plugins.PluginName`, but with typings */
    store: SettingsStore<Def> & PrivateSettings;
    /** Shorthand for `Plexcord.PlainSettings.plugins.PluginName`, but with typings */
