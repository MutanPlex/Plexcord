...
- Check the [plugin requests tracker](https://discord.com/channels/1342668210331324476/1374359281746448504) to see if your idea already exists or was rejected.
...
To keep Plexcord stable, secure and maintainable, all plugins must follow these rules:
...
## Improving Plexcord Itself

If you want to improve Plexcord beyond plugins, such as internal features or performance improvements, you are welcome to open a feature request so it can be discussed.
